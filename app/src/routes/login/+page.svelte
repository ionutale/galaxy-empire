  ...
  <div class="card p-6">
    ...
    <form on:submit={submit} class="space-y-3">
      <div class="form-control">
        ...
        <input id="login-username" class="input input-bordered" bind:value={username} required />
      </div>
      <div class="form-control">
        <label class="label" for="login-password"><span class="label-text">Password</span></label>
        <input id="login-password" class="input input-bordered" type="password" bind:value={password} required />
      </div>
