...
async function runTests() {
  ...
  const processedMissionsRes = await fetch(`${BASE_URL}/api/admin/processed-missions`, { headers: adminHeaders });
  console.log('Admin Processed Missions status:', processedMissionsRes.status);

  const processedBuildsRes = await fetch(`${BASE_URL}/api/admin/processed-builds`, { headers: adminHeaders });
